        ...
        if multiplicity == 1 || scale.is_empty() || !scale.len().is_multiple_of(multiplicity) {
            ...
            if !coprime_part.is_multiple_of(multiplicity) {
                ...
                if chain_length == 1 {
                    ...
                    let gener_chains_enumerated = (0..scale.len())
                        .map(|degree| {
                    ...
                    let gener_chains_vec: Vec<_> = gener_chains_enumerated.collect();
                    let gses: Vec<Vec<CountVector<Letter>>> = gener_chains_vec
                        .iter()
                            ...
                            (
                                ...
                                gener_chains_vec
                                    ...
                                    .filter(|(_, gener_chain)| {
                                        // println!("gener_chain: {:?}", gener_chain);
                                        //println!(
                                        //     "weak_period: {:?}",
                                        //     weak_period(&gener_chain[..chain_length - 1])
                                        // );
                                        weak_period(&gener_chain[..chain_length - 1]) == *gs
                                    })
